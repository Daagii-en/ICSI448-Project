...
// getSHA256 bit eer tulhuuriig hash lah
export const getSHA256 = async (value) => {
    return await CryptoJS.SHA256(value).toString();
}
//оруулсан файлын өргөтгөлийг шалгах checkCrypt function
...
//оруулсан файлыг encryption or decryption хийхийг шийдэх function.
...
// file iig decrypt leh gol function
...
//file iin code iig tailahad tuslah hint 
